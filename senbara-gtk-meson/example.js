...
import SenbaraGtkMeson from "gi://SenbaraGtkMeson?version=0.1";
...
const ExampleApplication = GObject.registerClass(
  ...
  class ExampleApplication extends Adw.Application {
    constructor() {
      super({
        application_id: "com.pojtinger.felicitas.SenbaraGtkMesonExample",
    ...
    vfunc_activate() {
      this.#window = new SenbaraGtkMeson.MainApplicationWindow({
        application: this,
      });
