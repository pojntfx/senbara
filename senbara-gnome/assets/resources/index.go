...
var (
	...
	ResourceMenusUIPath                      = path.Join(AppPath, "menus.ui")
	ResourcePageIndexUIPath                  = path.Join(AppPath, "page-index.ui")
	ResourcePageWelcomeUIPath                = path.Join(AppPath, "page-welcome.ui")
	ResourcePageConfigServerURLUIPath        = path.Join(AppPath, "page-config-server-url.ui")
	ResourcePagePreviewUIPath                = path.Join(AppPath, "page-preview.ui")
	ResourcePageRegisterUIPath               = path.Join(AppPath, "page-register.ui")
	ResourcePageConfigInitialAccessTokenPath = path.Join(AppPath, "page-config-initial-access-token.ui")
	ResourcePageExchangeLoginUIPath          = path.Join(AppPath, "page-exchange-login.ui")
	ResourcePageHomeUIPath                   = path.Join(AppPath, "page-home.ui")
	ResourcePageExchangeLogoutUIPath         = path.Join(AppPath, "page-exchange-logout.ui")
